...
public class MoonWalker extends JPanel
{
  ...
  Platform[] p = new Platform[500];
  private int s = 0;
  private int level = -1;
  Coin c1 = new Coin(this, 1000, 470, 0);
  Coin c2 = new Coin(this, 1000, 815, 1);
  Coin c3 = new Coin(this, 1000, 360, 2); 
  Button[] b = new Button[3];
  Door[] d = new Door[3];
  ExitDoor ed;
  PlatformDoor[] pd = new PlatformDoor[5];
  static String time;
  ...
  public void rebuild()
  {
    switch(level)
    {
      case -1:
        ...
        d[2] = new Door(this, 1000, 420, 0, true);
        pd[0] = new PlatformDoor(this, 1000, 300, 3, false);
        pd[1] = new PlatformDoor(this, 1000, 300, 3, false);
        pd[2] = new PlatformDoor(this, 1000, 300, 3, false);
        pd[3] = new PlatformDoor(this, 1000, 300, 3, false);
        pd[4] = new PlatformDoor(this, 1000, 300, 3, false);
      ...
      case 1:
        s = 0;
        c1 = new Coin(this, 630, 100, 0); 
        c2 = new Coin(this, 410, 640, 1);
        c3 = new Coin(this, 90, 120, 2); 
        b[0] = new Button(this, 800, 690, 2);
        b[1] = new Button(this, 900, 550, 3);
        b[2] = new Button(this, 1000, 550, 3);
        ed = new ExitDoor(this, 750, 330);
        sam.setJump(1);
        sam.setSpeed(0);
        sam.setShrink(0);
        //true is vertical, false is horizontal
        ...
        s = 98;
        for(int i = 420; i <= 420; i += 30)
        {
          for (int l = 720 ; l <= 810; l += 30)
          {
            p[s] = new Platform(this, l, i);
            s++;
          }
      ...
      case 2:
        s = 0;
        c1 = new Coin(this, 540, 465, 0);
        c2 = new Coin(this, 825, 675, 1);
        c3 = new Coin(this, 150, 75, 2); 
        b[0] = new Button(this, 45, 450, 0);
        b[1] = new Button(this, 765, 810, 1);
        b[2] = new Button(this, 1000, 550, 3);
        ed = new ExitDoor(this, 800, 120);
        sam.setJump(0);
        sam.setSpeed(0);
        sam.setShrink(1);
        //true is vertical, false is horizontal
      ...
      case 3:
        ...
        c2 = new Coin(this, 830, 815, 1);
        c3 = new Coin(this, 700, 550, 2); 
        b[0] = new Button(this, 200, 832, 2);
        b[1] = new Button(this, 660, 832, 0);
        b[2] = new Button(this, 300, 150, 3);
        ed = new ExitDoor(this, 800, 120);
        sam.setJump(0);
        sam.setSpeed(1);
        sam.setShrink(0);
        ...
        d[1] = new Door(this, 780, 750, 3, true);
        d[2] = new Door(this, 1000, 420, 0, true);
        pd[0] = new PlatformDoor(this, 180, 720, 2, false);
        pd[1] = new PlatformDoor(this, 510, 630, 0, true);
        pd[2] = new PlatformDoor(this, 840, 660, 0, true);
        pd[3] = new PlatformDoor(this, 660, 210, 3, false);
        pd[4] = new PlatformDoor(this, 510, 300, 0, false);
        ...
        p[s] = new Platform(this, 780, 720);
        s++;
        p[s] = new Platform(this, 810, 720);
        s++;
        p[s] = new Platform(this, 810, 750);
        s++;
        p[s] = new Platform(this, 810, 780);
        s++;
        p[s] = new Platform(this, 840, 780);
        s++;
        for(int i = 720; i <= 780; i += 30)
        {
          for (int l = 870; l <= 870; l += 30)
          {
            p[s] = new Platform(this, l, i);
            s++;
          }
        ...
        for(int i = 810; i <= 840; i += 30)
        {
          for (int l = 720; l <= 720; l += 30)
          {
            p[s] = new Platform(this, l, i);
            s++;
          }
        }
        for(int i = 540; i <= 570; i += 30)
        {
          for (int l = 750; l <= 780; l += 30)
          {
            p[s] = new Platform(this, l, i);
        ...
        {
          for (int l = 420; l <= 480; l += 30)
          {
            p[s] = new Platform(this, l, i);
            s++;
          }
        }
        for(int i = 180; i <= 210; i += 30)
        {
          for (int l = 300; l <= 330; l += 30)
          {
            p[s] = new Platform(this, l, i);
            s++;
          }
        }
        for(int i = 210; i <= 240; i += 30)
        {
      ...
      case 4:
        ...
        pd[2] = new PlatformDoor(this, 1000, 660, 0, true);
        pd[3] = new PlatformDoor(this, 1000, 210, 3, false);
        pd[4] = new PlatformDoor(this, 1000, 300, 0, false);
        for(int i = 0; i < p.length; i++)
        {
          p[i] = new Platform(this, 1000, 1000);
        }
  ...
  { 
    ...
    time = "" + (endTime/1000);
    g2d.setFont(new Font("Aharoni", Font.BOLD, 40));
    g2d.drawString(time, 445, 40);
    if(level > 4)
    {
      g2d.setFont(new Font("Aharoni", Font.BOLD, 100));
      g2d.drawString("YOU WIN! :)", 200, 445);
    }
    if(level == -1)
    {
      g2d.drawImage(title, 210, 250, null);
      g2d.drawImage(logo, 380, 390, null);
      g2d.setColor(Color.ORANGE);
      g2d.drawString("Start Game ----->", 495, 800);
      g2d.setFont(new Font("Aharoni", Font.BOLD, 30));
      g2d.setColor(Color.WHITE);
      g2d.drawString("A GAME BY NO LMT.", 320, 360);
    }
    for(int i = 0; i < p.length; i++)
    {
      p[i].paint(g2d);
    ...
    ed.paint(g2d);
    sam.paint(g2d);
    g2d.setFont(new Font("Aharoni", Font.BOLD, 12));
    g2d.setColor(Color.BLUE);
    g2d.drawString("Speed", 55, 55); 
    g2d.setColor(Color.RED);
    g2d.drawString("Jump", 156, 55); 
    g2d.setColor(new Color(0,150,0));
    g2d.drawString("Shrink", 250, 55); 
  }
